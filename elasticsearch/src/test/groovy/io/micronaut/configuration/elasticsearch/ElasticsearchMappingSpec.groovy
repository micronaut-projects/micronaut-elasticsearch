...
class ElasticsearchMappingSpec extends Specification {
    ...
    void "Test Elasticsearch(7.x) Mapping API"() {
        ...
        expect: "Make sure the version of ES is 7.7.0 because these tests may cause unexpected results"
        client.info(RequestOptions.DEFAULT).getVersion().getNumber().equals(Version.fromString("7.7.0").toString())
