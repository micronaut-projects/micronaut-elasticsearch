...
class ElasticsearchSpec extends Specification {
    ...
    @Shared ElasticsearchContainer elasticsearch = new ElasticsearchContainer("docker.elastic.co/elasticsearch/elasticsearch:7.6.0")
    ...
    void "Test simple info for Elasticsearch stats using the High Level REST Client"() {
        ...
        Version.fromString("7.6.0").toString() == response.getVersion().getNumber()
